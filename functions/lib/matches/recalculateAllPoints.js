...
exports.recalculateAllPoints = void 0;
/**
...
exports.recalculateAllPoints = (0, https_1.onCall)({ timeoutSeconds: 300 }, // Allow up to 5 minutes for large datasets
async (request) => {
    // Authorization: admin only
    if (!request.auth?.token?.admin) {
        throw new https_1.HttpsError("permission-denied", "Only administrators can recalculate points.");
    }
...
//# sourceMappingURL=recalculateAllPoints.js.map